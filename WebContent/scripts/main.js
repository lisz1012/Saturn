  ...
  function showSlides() {
	  var images = new Array(
			               "http://folkartcarsi.com/img/4.jpg",
			  			   "https://thumbs-prod.si-cdn.com/cAU0hdDob45w_75sItCT68WXbZQ=/800x600/filters:no_upscale()/https://public-media.si-cdn.com/filer/c5/d1/c5d13e71-f316-4b68-ac23-99b6384f4792/istock-602301816.jpg",//"http://folkartcarsi.com/images/modify/galeri/emirgan/big/1.png",
	  ...
	  setInterval(function() {
		  ...
		  //$(".container>header").animate({opacity: '0'},1000);  
		  $('.container>header').css("background", "url('" + images[i] + "') no-repeat 50% 50%");
		  //$(".container>header").animate({opacity: '1'},1000);
